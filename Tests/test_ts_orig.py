...
from rf_ts import RandomForest as RF_TS
from rf_orig import RandomForest as RF

#   Assume that all the folders inside the Data folder have 
#   requisite .npy training and testing files
datasets = os.listdir("../Data/")
clfs = []
logfile = "../Tests/testlogs_rf_orig_big.txt"
...
clfs.append(RF(numTrees=50, maxDepth=20))
